...
async fn main() -> Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/api/v1/mitre/tactics", get(aads_api::handlers::mitre::list_tactics))
        .route("/api/v1/mitre/techniques", get(aads_api::handlers::mitre::list_techniques))
        .route("/api/v1/ml/fp-model", get(aads_api::handlers::ml::get_fp_model))
        ...
        .route("/api/v1/logs/histogram", get(aads_api::handlers::logs::log_histogram))
        .route("/api/v1/logs/fields", get(aads_api::handlers::logs::log_fields))
        .route("/api/v1/logs/fields/values", get(aads_api::handlers::logs::log_field_values))
        ...
        .route("/api/v1/reports/{id}", get(aads_api::handlers::reports::get_report).delete(aads_api::handlers::reports::delete_report))
        ...
        .route("/api/v1/data-sources/apply-es-mapping", axum::routing::post(aads_api::handlers::settings::apply_es_mapping))
